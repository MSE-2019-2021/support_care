...
describe('Service Tests', () => {
  describe('Feedback routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing IFeedback for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new Feedback(id) })));
        ...
        expect(resultFeedback).toEqual(new Feedback(123));
      });
