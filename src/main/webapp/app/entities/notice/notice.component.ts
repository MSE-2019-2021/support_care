...
export class NoticeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.noticeService
      ...
      .subscribe(
        (res: HttpResponse<INotice[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: INotice[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
