...
export class ProtocolComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.protocolService
      ...
      .subscribe(
        (res: HttpResponse<IProtocol[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IProtocol[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
