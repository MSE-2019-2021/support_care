...
export class DrugComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.drugService
      ...
      .subscribe(
        (res: HttpResponse<IDrug[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDrugs(): void {
    this.eventSubscriber = this.eventManager.subscribe('drugListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDrug[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
