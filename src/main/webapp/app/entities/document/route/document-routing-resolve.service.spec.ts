...
describe('Service Tests', () => {
  describe('Document routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing IDocument for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new Document(id) })));
        ...
        expect(resultDocument).toEqual(new Document(123));
      });
