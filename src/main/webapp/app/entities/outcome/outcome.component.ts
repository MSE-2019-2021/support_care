...
export class OutcomeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.outcomeService
      ...
      .subscribe(
        (res: HttpResponse<IOutcome[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInOutcomes(): void {
    this.eventSubscriber = this.eventManager.subscribe('outcomeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IOutcome[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
