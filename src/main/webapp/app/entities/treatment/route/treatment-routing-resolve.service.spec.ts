...
describe('Service Tests', () => {
  describe('Treatment routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing ITreatment for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new Treatment(id) })));
        ...
        expect(resultTreatment).toEqual(new Treatment(123));
      });
