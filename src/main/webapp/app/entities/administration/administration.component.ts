...
export class AdministrationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.administrationService
      ...
      .subscribe(
        (res: HttpResponse<IAdministration[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInAdministrations(): void {
    this.eventSubscriber = this.eventManager.subscribe('administrationListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAdministration[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
