...
export class DiagnosticComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.diagnosticService
      ...
      .subscribe(
        (res: HttpResponse<IDiagnostic[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDiagnostics(): void {
    this.eventSubscriber = this.eventManager.subscribe('diagnosticListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDiagnostic[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
