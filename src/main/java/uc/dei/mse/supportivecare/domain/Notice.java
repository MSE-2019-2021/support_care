...
public class Notice extends AbstractAuditingEntity implements Serializable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "gen_notice_id_seq")
    @SequenceGenerator(name = "gen_notice_id_seq", sequenceName = "notice_id_seq", initialValue = 1, allocationSize = 1)
    private Long id;
