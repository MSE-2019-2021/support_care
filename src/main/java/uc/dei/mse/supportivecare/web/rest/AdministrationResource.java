...
public class AdministrationResource {
    ...
    public ResponseEntity<AdministrationDTO> createAdministration(@Valid @RequestBody AdministrationDTO administrationDTO) throws URISyntaxException {
    ...
    public ResponseEntity<AdministrationDTO> updateAdministration(@Valid @RequestBody AdministrationDTO administrationDTO) throws URISyntaxException {
