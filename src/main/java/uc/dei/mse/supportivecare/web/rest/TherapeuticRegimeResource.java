...
public class TherapeuticRegimeResource {
    ...
    public TherapeuticRegimeResource(
        TherapeuticRegimeService therapeuticRegimeService,
        TherapeuticRegimeQueryService therapeuticRegimeQueryService
    ) {
    ...
    public ResponseEntity<TherapeuticRegimeDTO> createTherapeuticRegime(@Valid @RequestBody TherapeuticRegimeDTO therapeuticRegimeDTO)
        ...
        return ResponseEntity
            .created(new URI("/api/therapeutic-regimes/" + result.getId()))
    ...
    public ResponseEntity<TherapeuticRegimeDTO> updateTherapeuticRegime(@Valid @RequestBody TherapeuticRegimeDTO therapeuticRegimeDTO)
        throws URISyntaxException {
    ...
    /**
     * {@code PATCH  /therapeutic-regimes} : Updates given fields of an existing therapeuticRegime.
     *
     * @param therapeuticRegimeDTO the therapeuticRegimeDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated therapeuticRegimeDTO,
     * or with status {@code 400 (Bad Request)} if the therapeuticRegimeDTO is not valid,
     * or with status {@code 404 (Not Found)} if the therapeuticRegimeDTO is not found,
     * or with status {@code 500 (Internal Server Error)} if the therapeuticRegimeDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<TherapeuticRegimeDTO> partialUpdateTherapeuticRegime(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, therapeuticRegimeDTO.getId().toString())
        );
    }
