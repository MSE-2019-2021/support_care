...
/**
 * A DTO for the {@link uc.dei.mse.supportcare.domain.Guide} entity.
 */
@ApiModel(description = "Guide.")
public class GuideDTO implements Serializable {
     ...
     */
    @NotNull
    @ApiModelProperty(value = "Guia.", required = true)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GuideDTO)) {
            return false;
        }

        return id != null && id.equals(((GuideDTO) o).id);
    }
