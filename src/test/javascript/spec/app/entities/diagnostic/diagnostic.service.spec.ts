...
describe('Service Tests', () => {
  describe('Diagnostic Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(DiagnosticService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Diagnostic(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Diagnostic', () => {
        ...
        service.create(new Diagnostic()).subscribe(resp => (expectedResult = resp.body));
