...
import { GuideComponent } from 'app/entities/guide/guide.component';
import { GuideService } from 'app/entities/guide/guide.service';
import { Guide } from 'app/shared/model/guide.model';

describe('Component Tests', () => {
  describe('Guide Management Component', () => {
    let comp: GuideComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GuideComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.guides && comp.guides[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
