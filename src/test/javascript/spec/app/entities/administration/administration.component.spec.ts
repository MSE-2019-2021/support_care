...
import { AdministrationComponent } from 'app/entities/administration/administration.component';
...
describe('Component Tests', () => {
  describe('Administration Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.administrations && comp.administrations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
